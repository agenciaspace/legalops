          ...
          <div>
            <div className="border border-[#CEC8BD] bg-[#FAF7F1] p-5">
              ...
              <form action={createBenchTopic} className="mt-5 space-y-3">
                ...
                <label className="block text-[10px] font-bold text-[#716B65]">Formato<select name="participation_mode" defaultValue="remoto" className="mt-1 w-full rounded-lg border border-[#CEC8BD] bg-white px-3 py-2.5 text-sm"><option value="remoto">Remoto</option><option value="presencial">Presencial</option><option value="hibrido">Híbrido</option></select></label>
                <textarea name="participation_details" rows={3} maxLength={2000} placeholder="Como participar: endereço, link, portaria, materiais necessários…" className="w-full rounded-lg border border-[#CEC8BD] bg-white px-3 py-2.5 text-sm" />
                <textarea name="pre_questions" rows={3} maxLength={3000} placeholder="Perguntas prévias (uma por linha)" className="w-full rounded-lg border border-[#CEC8BD] bg-white px-3 py-2.5 text-sm" />
                <textarea name="extra_registration_fields" rows={2} placeholder='Campos extras em JSON: [{"key":"empresa_visitada","label":"Empresa que visitará","required":true}]' className="w-full rounded-lg border border-[#CEC8BD] bg-white px-3 py-2.5 text-sm" />

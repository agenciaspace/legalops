          ...
          <div className="mx-auto max-w-[1180px] px-5 py-16 sm:px-8 sm:py-24">
            <div className="max-w-[820px]">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <Link href="/community/calendar#bench" className="inline-flex items-center gap-2 rounded-lg border border-[#C9684F] bg-[#FFF4EE] px-5 py-3 text-sm font-bold text-[#A94E38] hover:bg-[#FFE9DE]">

...
export default function ToolsPage() {
 const t = getClubTranslator()
  ...
  return <main className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6">
    ...
    <p className="mt-5 text-xs leading-5 text-[#817A73]">{t("Explore os projetos abertos. Em Migração de CLM, comente e proponha melhorias aqui no Club; membros-lead revisam antes da publicação.")}</p>
  </main>
}

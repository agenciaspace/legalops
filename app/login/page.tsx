      ...
      <div className="w-full max-w-sm">
        ...
        <div className="mt-6 grid grid-cols-3 gap-3">
          <div className="bg-white/80 rounded-xl p-3 text-center border border-slate-100">
            ...
            <p className="text-xs text-slate-400">{t.login.featureDiscoveryDesc}</p>
          </div>
          <div className="bg-white/80 rounded-xl p-3 text-center border border-slate-100">
            ...
            <p className="text-xs text-slate-400">{t.login.featureAIDesc}</p>
          </div>
          <div className="bg-white/80 rounded-xl p-3 text-center border border-slate-100">
            ...
            <p className="text-xs text-slate-400">{t.login.featurePipelineDesc}</p>
          </div>
        </div>

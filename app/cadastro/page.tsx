  ...
  return <main className="min-h-screen bg-[#F5F1E8] px-5 py-12 text-[#111111] sm:py-20">
    <div className="mx-auto max-w-lg">
      ...
      <aside className="mt-8 rounded-xl bg-[#111111] p-5 text-[#F5F1E8]">
        ...
        <p className="mt-3 text-sm leading-6 text-[#CEC8BD]">Retomar conversas, encontrar oportunidades no Work e levar ideias para projetos no Dev: é para isso que estamos preparando o Pro.</p>
        <Link href="/club#pro" className="mt-4 inline-flex min-h-11 items-center font-semibold text-[#E88A6A] underline underline-offset-4">Veja o que o Pro vai fazer por você →</Link>
      </aside>
    </div>
  </main>
}

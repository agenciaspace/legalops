-- Access and directory visibility are intentionally separate. Imported members keep their
-- active entitlement, while generic placeholder cards remain hidden until the
-- member adds a real name and basic professional context.

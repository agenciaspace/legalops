...
export function ClubLanguageSelect() {
  ...
  return <div><label className="inline-flex min-h-11 items-center gap-1 rounded-lg border border-[#CEC8BD] bg-white px-2 text-xs font-semibold">
    ...
    }} className="min-h-11 max-w-24 bg-transparent text-xs outline-offset-2"><option value="pt-BR">Português</option><option value="en">English</option><option value="es">Español</option></select>
